...
public class Main {
    public static void main(String[] args) {
        ...
        User user1 = new User("Kirill", "Kolomok", (byte)28);
        User user2 = new User("Nikita", "Kolesnichenko", (byte)28);
        User user3 = new User("Alex", "Belyaev", (byte)28);
        User user4 = new User("Viktor", "Kurkin", (byte)30);
        ...
        System.out.println("Users успешно удалены");
